...
export default function PlayQuiz() {
    ...
    const [gameState, setGameState] = useState('joining'); // joining, waiting, countdown, question, result, leaderboard, end
                            ...
                            {result.time && (
                                <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-3 mb-4">
                                    <p className="text-gray-700 dark:text-gray-300">
                                        You answered in <span className="font-bold">{result.time}</span> seconds
                                    </p>
                                </div>
                            )}
                            ...
                            <div className="space-y-3">
                                {leaderboard.map((player, index) => (
                                    <motion.div
                                        ...
                                        transition={{ delay: index * 0.1 }}
                                        className={`flex items-center p-3 rounded-lg ${player.id === socket.id
                                ...
                                <div className="mb-8">
                                    ...
                                    {leaderboard.slice(0, 3).map((player, index) => (
                                        <motion.div
                                            ...
                                            className={`flex items-center p-4 rounded-lg mb-2 ${index === 0
                                        ...
                                        >
                                            <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold mr-3 ${index === 0
